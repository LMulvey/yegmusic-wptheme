...
<div id="page" class="site">
  ...
  <?php endif; ?>
	 ...
	 */
	if ( ( is_single() || ( is_page() && ! yegmusic_is_frontpage() ) ) && has_post_thumbnail( get_queried_object_id() ) ) :
		echo '<div class="single-featured-image-header">';
		echo get_the_post_thumbnail( get_queried_object_id(), 'yegmusic-featured-image' );
