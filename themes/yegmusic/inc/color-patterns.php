 ...
 */
function yegmusic_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter YEGMusic default saturation level.
	 *
	 * @since YEGMusic 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'yegmusic_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.yegmusic-front-page) .entry-title,
...
.colors-custom .yegmusic-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.yegmusic-front-page .panel-content .recent-posts article,
...
.colors-custom.yegmusic-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters YEGMusic custom colors CSS.
	 *
	 * @since YEGMusic 1.0
	 *
	 ...
	 */
	return apply_filters( 'yegmusic_custom_colors_css', $css, $hue, $saturation );
}
